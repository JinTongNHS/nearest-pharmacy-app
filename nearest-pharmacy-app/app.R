    ...
    column(3,
           radioButtons("serviceType", label = h5("Search across"),
                        choices = list("Pharmacies delivering essential services (including NHS Discharge Medicines Service)" = "All", 
                                       "All pharmacies delivering NHS smoking cessation services" = "smoking",
                                       "Only pharmacies delivering CPCS" = "cpcs",
                                       "Only pharmacies delivering NHS contraception services" = "contraception",
                                       "Only pharmacies delivering NHS blood pressure check services" = "bp",
                                       #"Only pharmacies registered to deliver targeted lung health check services" = "tlhc",
                                       "Only pharmacies delivering NMS expansion pilot service" = "nms"), 
                        selected = "All")
    ),
    column(3,
